...
import { ImportWarehouseReceivingModal } from './ImportWarehouseReceivingModal';
import { useImportWarehouseReceivingTab } from '../../hooks/useImportWarehouseReceivingTab';

export const ImportWarehouseReceivingTab = () => {
  const {
    ...
    unresolved,
    hasBlocking,
  } = useImportWarehouseReceivingTab();
      ...
      <div className="flex flex-col gap-3 rounded-md border border-slate-200 p-4 shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm font-medium text-slate-700">
            ...
            Print Import Warehouse Receiving Note
          </div>
          <FormPrintButton
            ...
            fileName="import-warehouse-receiving-note.pdf"
