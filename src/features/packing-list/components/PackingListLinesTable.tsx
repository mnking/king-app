...
import type { PackingListStatus, PackingListLineFormValues } from '../types';
import { PackingListLineInlineForm } from './PackingListLineInlineForm';

type TableLine = PackingListLineFormValues & {
  clientId: string;
  persistedId?: string;
  isDirty?: boolean;
};

interface PackingListLinesTableProps {
  lines: TableLine[];
  loading: boolean;
  ...
  onLineChange?: (
    ...
    value: PackingListLineFormValues[keyof PackingListLineFormValues],
  ) => void;
...
export const PackingListLinesTable: React.FC<PackingListLinesTableProps> = ({
  lines,
  loading,
  packingListStatus,
  isEditable,
  ...
  const isEditableStatus =
    isEditable && (packingListStatus === 'DRAFT' || packingListStatus === 'PARTIAL');
  const canInlineEdit = inlineEditable && isEditableStatus;
  const canExpandRows = true;
  const canAddLine = isEditableStatus;
...
export default PackingListLinesTable;
