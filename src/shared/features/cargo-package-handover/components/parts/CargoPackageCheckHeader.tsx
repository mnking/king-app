...
export const CargoPackageCheckHeader: React.FC<HeaderProps> = ({
  ...
  const packingListDisplay = packingListLabel?.trim() || primaryPackingListId || '—';
  const workingStatusLabel = flow?.workingStatus
    ...
    <header className="rounded-xl border border-slate-200 bg-white/80 px-4 py-3 shadow-sm backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/80">
      ...
      >
        <div className="flex flex-wrap items-center gap-2">
          <SummaryPill label="Handed Over" value={totalChecked} />
        </div>
