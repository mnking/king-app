...
const CargoPackageCheckPage: React.FC = () => {
  return (
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
            Validate the shared cargo package check component with hardcoded data before backend integration.
          </p>
        </div>
...
export default CargoPackageCheckPage;
